...
| P8以降の仕様・チェックリスト | [docs/spec/lakda-extension/](docs/spec/lakda-extension/) |
| P8以降の評価・実装計画 | [評価](docs/spec/lakda-extension/EVALUATION-LAKDA-EXTENSION.md) / [実装計画](docs/IMPLEMENTATION-PLAN-LAKDA-EXTENSION.md) |
