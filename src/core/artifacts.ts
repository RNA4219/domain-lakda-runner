...
import type { ActionPlan, Failure, LakdaConfig, LlmEvidence, LlmStatus, RunOutcome, TerminationReason } from "./types.js";
import { redact } from "./redaction.js";
import { writeCanonicalJson, writeJson, writeText } from "./artifact-store.js";
...
type CollectorContext = { workerIndex?: number; batchId?: string };
...
export class ArtifactCollector {
  ...
  static async create(config: LakdaConfig, mode: string, context: CollectorContext = {}): Promise<ArtifactCollector> {
    ...
    const metadata: RunMetadata = {
      ...
      producerVersion: "0.2.0", commitSha: commitSha(), llmStatus: "not_requested", workerIndex: context.workerIndex ?? 0,
