...
export async function runExternalSmoke(baseUrl = process.env.LAKDA_EXTERNAL_BASE_URL, outputDir = process.env.LAKDA_EXTERNAL_OUTPUT_DIR ?? ".lakda/external-smoke"): Promise<ExternalSmokeResult> {
