...
const required = ["revision", "staging-origin", "full-report", "full-bundle", "worker-report", "worker-bundle", "manual-record", "ctg-readiness", "ctg-triage", "ctg-qeg", "hate-bundle", "hate-upstream", "approver", "out"];
...
console.log(JSON.stringify({ schemaVersion: "lakda/release-gate-preparation/v1", status: "ready-for-qeg", qegInput: result.output, chainEvidenceHash: result.chainEvidenceHash, finalVerdictAuthority: "qeg" }, null, 2));