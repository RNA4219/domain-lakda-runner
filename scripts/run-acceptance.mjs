...
const worktreeDirty = execFileSync("git", ["status", "--porcelain"], { cwd: repoRoot, encoding: "utf8" }).trim().length > 0;
const hardeningCommand = "node node_modules/playwright/cli.js test tests/v02.spec.ts";
let hardeningSuitePassed = false;
try {
