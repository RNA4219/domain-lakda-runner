...
- [x] CHK-LX-002-S-002 — rule-first、ref allowlist、schema reject、明示設定時だけのrule-only degradation契約が定義されている。
...
| [x] | CHK-LX-002-I-006 | REQ-LX-SIG-006 | 明示設定rule-only degradation test | tests/adaptive/scout-degradation.spec.ts |
| [x] | CHK-LX-002-I-007 | REQ-LX-LLM-001 | loopback/attestation test | tests/adaptive/scout-degradation.spec.ts |
| [ ] | CHK-LX-002-I-008 | REQ-LX-LLM-002 | context redaction test | 未取得 |
| [x] | CHK-LX-002-I-009 | REQ-LX-LLM-003 | strict schema negative | tests/adaptive/scout-degradation.spec.ts |
| [x] | CHK-LX-002-I-010 | REQ-LX-LLM-004 | ref allowlist test | tests/adaptive/scout-degradation.spec.ts |
| [ ] | CHK-LX-002-I-011 | REQ-LX-LLM-005 | forbidden field rejection | 未取得 |
| [x] | CHK-LX-002-I-012 | REQ-LX-LLM-006 | timeout/provider no-switch test | tests/adaptive/scout-degradation.spec.ts |
| [x] | CHK-LX-002-I-013 | REQ-LX-LLM-007 | JSONL evidence/redaction test | tests/adaptive/scout-degradation.spec.ts |
...
- [ ] CHK-LX-002-A-004 — configでrule-onlyを明示した場合だけ縮退してpartial扱いを維持し、loopback LLM failureでは暗黙縮退しなかった。
