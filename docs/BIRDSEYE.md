...
- v0.2.1証跡是正: [TASK.20260714-07.md](tasks/TASK.20260714-07.md)、[20-run coverage訂正](acceptance/AC-20260714-02.v021-evidence-contract-correction.md)、[RC manual設計](release-gate/manual_case_set.json)。
