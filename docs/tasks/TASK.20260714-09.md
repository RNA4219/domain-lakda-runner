...
# Task Seed: 設定・Safety Policy・kill switch
...
REQ-SAFE-001〜005を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- REQ-SAFE-001〜005に対応する自動試験が通過する。
