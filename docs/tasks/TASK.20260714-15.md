...
# Task Seed: Playwrightフォーム・popup・iframe統合
...
REQ-PW-001〜003を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
