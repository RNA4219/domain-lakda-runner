...
# Task Seed: Adapter SPIとlossless error boundary
...
| primary spec | [仕様書](../spec/adaptive-exploration/SPEC-01-COMMON-CORE.md) |
...
REQ-ADP-001〜004を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
