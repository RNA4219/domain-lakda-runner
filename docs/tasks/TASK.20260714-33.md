...
# Task Seed: ZAP/HTTP bridgeと候補分類
...
REQ-SECX-001〜008を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- REQ-SECX-001〜008に対応する自動試験が通過する。
