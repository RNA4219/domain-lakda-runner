...
# Task Seed: Security mutation/race安全制御
...
REQ-SECX-005〜008を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- REQ-SECX-005〜008に対応する自動試験が通過する。
