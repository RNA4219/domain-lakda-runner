...
# Task Seed: Security authorization fail-closed policy
...
| primary spec | [仕様書](../spec/adaptive-exploration/SPEC-06-SECURITY-ADAPTER.md) |
...
REQ-SECX-001〜004を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- REQ-SECX-001〜004に対応する自動試験が通過する。
...
- fixture受入: [AC-20260715-05](../acceptance/AC-20260715-05.adaptive-shrink-bridge-fixture.md)
