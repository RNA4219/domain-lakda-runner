...
# Task Seed: coverage metricと分母記録
...
REQ-COV-001〜008を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
