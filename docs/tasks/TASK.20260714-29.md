...
# Task Seed: Airtest/Poco loopback bridge契約
...
| primary spec | [仕様書](../spec/adaptive-exploration/SPEC-05-AIRTEST-POCO-ADAPTER.md) |
| linked checklist | [対応チェックリスト](../spec/adaptive-exploration/CHECKLIST-05-AIRTEST-POCO-ADAPTER.md) |
| plan | [適応型探索実装計画](../IMPLEMENTATION-PLAN-ADAPTIVE-EXPLORATION.md) |

## Objective

REQ-GAME-001〜004を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- REQ-GAME-001〜004に対応する自動試験が通過する。
