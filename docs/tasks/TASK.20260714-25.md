...
# Task Seed: timeout証跡・backtrack復旧
...
REQ-REC-004〜007を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- timeout quarantine・recovery safety受入: [AC-20260715-12](../acceptance/AC-20260715-12.timeout-quarantine-recovery-safety.md)
- 残件: 実機、認可済みSecurity target、QEGでのreal証跡。
