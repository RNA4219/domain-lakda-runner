...
REQ-GRAPH-001〜007を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- REQ-GRAPH-001〜007に対応する自動試験が通過する。
