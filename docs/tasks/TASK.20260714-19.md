...
# Task Seed: generic/product/security oracle分離
...
REQ-ORC-001〜007を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
