...
# Task Seed: フォーム入力Safetyと禁止mutation
...
REQ-INP-003〜006を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
