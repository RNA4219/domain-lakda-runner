...
# Task Seed: Playwright target topologyの観測
...
| primary spec | [仕様書](../spec/adaptive-exploration/SPEC-04-PLAYWRIGHT-ADAPTER.md) |
| linked checklist | [対応チェックリスト](../spec/adaptive-exploration/CHECKLIST-04-PLAYWRIGHT-ADAPTER.md) |
| plan | [適応型探索実装計画](../IMPLEMENTATION-PLAN-ADAPTIVE-EXPLORATION.md) |

## Objective

REQ-WEB-001〜007を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
...
- frame/off-page event受入: [AC-20260715-10](../acceptance/AC-20260715-10.playwright-frame-offpage-events.md)
- dialog/topology event受入: [AC-20260715-11](../acceptance/AC-20260715-11.playwright-dialog-target-topology.md)
- 残件: REQ-WEB-006の固定corpus strict replay反復評価。
