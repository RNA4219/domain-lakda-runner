...
# Task Seed: adaptive traceとstrict replay divergence
...
| primary spec | [仕様書](../spec/adaptive-exploration/SPEC-03-REPLAY-ORACLE-EVIDENCE.md) |
| linked checklist | [対応チェックリスト](../spec/adaptive-exploration/CHECKLIST-03-REPLAY-ORACLE-EVIDENCE.md) |
| plan | [適応型探索実装計画](../IMPLEMENTATION-PLAN-ADAPTIVE-EXPLORATION.md) |

## Objective

REQ-REP-001〜006を、共通契約・Safety Policy・Artifact Policyを経由して最小実装とtests-firstで満たす。
