...
- v0.2のArtifact Store、Artifact/Outcome Policy、共有Action Budget、逐次worker batch。
...
| M6 | post-v1 の cross-browser と追加 profile | M5 の受入後 |
...
- 次の実装入口は `docs/tasks/TASK.20260713-05.md` とする。
