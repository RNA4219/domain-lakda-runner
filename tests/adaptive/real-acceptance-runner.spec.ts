...
const variableNames = ["LAKDA_ADAPTIVE_REAL_CONFIG", "LAKDA_ADAPTIVE_REAL_CONFIRM", "LAKDA_ADAPTIVE_CORPUS_PATH", "LAKDA_ADAPTIVE_CASE_ID", "LAKDA_ADAPTIVE_ENVIRONMENT", "LAKDA_ADAPTIVE_TARGET_REVISION"];
