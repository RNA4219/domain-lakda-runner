...
test("release package scanner verifies metadata, required files, hashes, and sensitive paths", async () => {
  ...
  try {
    ...
    await writeFile(join(root, "package.json"), JSON.stringify({
      name: "domain-lakda-runner", version: "0.4.0-rc.3", private: true, main: "./dist/index.js", types: "./dist/index.d.ts",
    ...
    for (const [path, value] of [
      ...
      ["README.md", "# Lakda\n\n現在の候補版は `0.4.0-rc.3` です。\n"], ["RUNBOOK.md", "# Runbook\n"],
      ["dist/index.js", "export const version = '0.4.0-rc.3';\n"], ["dist/index.d.ts", "export declare const version: string;\n"],
    ...
    expect(JSON.parse(stdout)).toMatchObject({ status: "passed", packageVersion: "0.4.0-rc.3", fileCount: 16 });
