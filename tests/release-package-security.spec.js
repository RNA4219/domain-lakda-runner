...
test("release package scanner verifies metadata, required files, hashes, and sensitive paths", async () => {
  ...
  try {
    ...
    await writeFile(join(root, "package.json"), JSON.stringify({
      name: "domain-lakda-runner", version: "0.3.0-rc.3", private: true, main: "./dist/index.js", types: "./dist/index.d.ts",
      exports: { ".": { types: "./dist/index.d.ts", import: "./dist/index.js" } },
    }));
    for (const [path, value] of [
      ["CHANGELOG.md", "# Changes\n"], ["LICENSE", "MIT\n"], ["README.md", "# Lakda\n"], ["RUNBOOK.md", "# Runbook\n"],
      ["dist/index.js", "export const version = '0.3.0-rc.3';\n"], ["dist/index.d.ts", "export declare const version: string;\n"],
    ...
    expect(JSON.parse(stdout)).toMatchObject({ status: "passed", packageVersion: "0.3.0-rc.3", fileCount: 10 });
